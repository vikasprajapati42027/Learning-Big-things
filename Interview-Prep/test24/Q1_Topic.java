...
public class Q1_Scenario {
    ...
    private static void executeCoreLogic() throws InterruptedException {
        ...
        executor.submit(() -> { System.out.println("Running NoSQL scalability audit."); latch.countDown(); });
        executor.submit(() -> { System.out.println("Running resilience & concurrency check."); latch.countDown(); });
        latch.await();
        executor.shutdown();
